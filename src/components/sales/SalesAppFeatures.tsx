    ...
    <section className="bg-[hsl(0,0%,5%)] text-white py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <span className="inline-block bg-[hsl(45,100%,50%/0.15)] text-[hsl(45,100%,50%)] text-sm font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-4">
            Tudo no Aplicativo
          </span>
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
            O Que Você Recebe no{" "}
            <span className="text-[hsl(45,100%,50%)]">App</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div
              key={i}
              className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-[hsl(45,100%,50%/0.4)] transition-all duration-300 group"
            >
              <div className="w-14 h-14 rounded-xl bg-[hsl(45,100%,50%/0.15)] flex items-center justify-center mb-4 group-hover:bg-[hsl(45,100%,50%/0.25)] transition-colors">
                <f.icon className="w-7 h-7 text-[hsl(45,100%,50%)]" />
              </div>
