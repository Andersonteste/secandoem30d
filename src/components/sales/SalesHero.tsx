  ...
  return (
    <section className="relative overflow-hidden bg-[hsl(0,0%,5%)] text-white">
      ...
      <div className="relative max-w-3xl mx-auto px-4 py-12 md:py-20 text-center">
          ...
          <img
            src={logoDesafio}
            alt="Secando em Casa - Pedro Bahia"
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.4rem] font-extrabold leading-[1.1] mb-6">
            Seu Personal Online para{" "}
            <span className="bg-gradient-to-r from-[hsl(24,100%,50%)] to-[hsl(145,100%,55%)] bg-clip-text text-transparent">Treinos, Alimentação</span>{" "}
            e Evolução
          </h1>

          <p className="text-base md:text-lg text-white/75 mb-8 max-w-xl mx-auto">
            Treinos em casa e na academia, alimentação, receitas, hábitos, água, sono,
            evolução e comunidade — tudo em um só lugar, guiado pelo seu perfil.
          </p>
